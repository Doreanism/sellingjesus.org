...
This page itself has no legal value other than to signify that a rights holder has applied the CC0 to their work. All text is explanatory only and not part of the CC0 legal code. _sellingjesus.org_ is not a law firm and does not provide legal services. Distributing, displaying, or linking to this page does not create an attorney-client relationship. _sellingjesus.org_ has not verified the copyright status of any work to which this page has been applied. We make no warranties about any work or its copyright status in any jurisdiction, and disclaim all liability for all uses of any work.
:::
