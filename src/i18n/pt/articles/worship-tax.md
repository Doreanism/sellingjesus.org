...
Muitas das canções que acabam se tornando populares vêm de grupos com práticas ou teologia questionáveis.[^5] Os exemplos mais proeminentes são as bandas associadas a Hillsong, Bethel e Elevation. De acordo com estatísticas de licenciamento, pelo menos metade das 100 canções de louvor mais usadas em cultos são de artistas com fortes conexões a um desses três.[^6] Parte dos royalties dessas canções é até paga diretamente para essas igrejas.[^7] Embora algumas igrejas tenham escolhido não cantar suas músicas, as estatísticas mostram que muitas ainda o fazem. Portanto, grande parte do dinheiro que as igrejas despejam na indústria musical vai para artistas que já têm mais do que precisam, ou para entidades com as quais seria imprudente ter vínculo financeiro.


## O Facilitador do Negócio – CCLI

A principal organização que viabiliza esse modelo de negócios é a Christian Copyright Licensing International (CCLI), utilizada por mais de 250.000 igrejas em pelo menos 70 países.[^8] Existem outras organizações de licenciamento, mas elas se concentram em casos de uso diferentes, de modo que a CCLI tem um monopólio virtual sobre o licenciamento padrão necessário para cultos contemporâneos.[^9]

A CCLI surgiu originalmente por causa do medo de que igrejas pudessem ser processadas por infração de direitos autorais por artistas cristãos. Eles apontam para um caso de 1984 em que um autor de canções como “Eles Saberão que Somos Cristãos pelo Amor” processou uma diocese católica em Chicago (veja 1 Cor 6).[^10] Apesar desse precedente jurídico, não conheço outros casos em que artistas cristãos tenham tentado processar igrejas.[^11] Ainda assim, um dos motivos que a CCLI apresenta para que igrejas paguem suas licenças é garantir que estejam legalmente “cobertas” contra tais processos.[^12]

Embora se descreva como um ministério[^13] e tenha origem em uma igreja nos Estados Unidos, a CCLI sempre foi uma empresa privada com fins lucrativos.[^14] Em 2016, o negócio foi vendido para uma empresa secular que também vende licenças musicais, chamada SESAC.[^15] Isso pode parecer um encaixe natural, já que ambas têm modelos de negócios semelhantes, mas elas não têm clientelas semelhantes. A CCLI atende exclusivamente artistas cristãos e igrejas, e ainda se identifica como cristã no nome, mas agora está sob propriedade e controle seculares.

Presumivelmente, o proprietário da CCLI examinou cuidadosamente a SESAC antes de vender um negócio cristão do qual mais de 250.000 igrejas dependem e ao qual pagam milhões de dólares. Na época da venda da CCLI, a SESAC era majoritariamente de propriedade da Rizvi Traverse Management,[^16] uma firma de investimento privado que também detinha uma participação significativa na Playboy (o negócio de pornografia).[^17] A SESAC agora foi vendida (e a CCLI junto com ela) para outra firma de investimento chamada Blackstone.[^18] A Blackstone possui muitas empresas diferentes, algumas das quais têm práticas preocupantes.[^19] Mas seu principal objetivo, como qualquer firma de investimento, é simplesmente maximizar os lucros para seus acionistas.


::: figure /_assets/worship-tax/rizvi_portfolio.jpg
Esta é uma captura de tela da página pública de portfólio do proprietário principal da SESAC antes da venda da CCLI para a SESAC.[^20] Observando que o proprietário (Rizvi Traverse Management) não apenas investiu na SESAC, mas tinha uma participação de controle (pelo menos 75%) e também uma participação influente na Playboy.
:::

Para ficar claro, a questão aqui não é que a CCLI esteja envolvida em qualquer negócio desonroso, mas que foi confiada aos proprietários de negócios desonrosos. Esses proprietários agora também lucram com a adoração a Deus. Mesmo que a CCLI não tivesse sido vendida a uma empresa secular, não há razão para que devesse ter sido com fins lucrativos em primeiro lugar.

A CCLI só oferece licenças anuais, que não se baseiam em quantas canções são cantadas nos cultos. Embora isso possa ser administrativamente conveniente, também significa que as igrejas continuam pagando mesmo se cantarem músicas de [domínio público](https://copy.church/explain/copyright/#disabling-copyright). Uma igreja que canta principalmente hinos antigos e usa canções modernas com direitos autorais apenas 10% do tempo ainda pagará como se as tivesse usado 100% do tempo.

Os próprios artistas também têm se aproveitado de hinos de domínio público, fazendo pequenas alterações e, subsequentemente, coletando royalties por sua nova versão.[^21] Ninguém coleta royalties pelo “Amazing Grace” original.[^22] A versão de Chris Tomlin e Louie Giglio desde então se tornou extremamente popular. Ela é a 20<sup>a</sup> canção mais popular na CCLI no momento da redação. O sucesso claramente não se deve apenas ao refrão acrescentado. Muitas igrejas que cantariam regularmente o “Amazing Grace” original agora cantam a versão de Tomlin e Giglio, proporcionando aos proprietários royalties abundantes.
...
Quando a música cristã contemporânea começou a emergir — e a ser comercializada — um artista se recusou a lucrar com o evangelho. Keith Green, um dos artistas cristãos mais populares de seu tempo, era categórico: “se é ministério, você não pode cobrar.”[^45] Keith não queria que ninguém fosse impedido de ouvir o evangelho através de sua música, e estava convicto de não cobrar por ingressos para seus concertos (a que milhares compareciam) e de dar discos de graça.[^46] Ele morreu em um trágico acidente aos 28 anos, mas sua música continua impactando centenas de milhares de pessoas hoje. Os artistas têm seu modelo: um homem que se recusou a comprometer-se e levou a sério as palavras de Jesus: “de graça recebestes, de graça dai” (Mateus 10:8).
